<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-recycle fa-fw"></i> Thể loại<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-recycle fa-fw"></i> Loại tin<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <!-- <li>
                            <a href="#"><i class="fa fa-tree fa-fw"></i> Loại tin<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/loaitin/danhsach">Danh sách loại tin</a>
                                </li>
